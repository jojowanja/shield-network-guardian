...
export function AboutSection() {
  const developers = [
    ...
    },
    {
      ...
      expertise: "React & Backend Systems"
    },
    {
      name: "Michael Johnson",
      role: "Network Architect",
      expertise: "Infrastructure & DevOps"
    }
  ];
    ...
    <div className="space-y-8">
        ...
        <CardHeader>
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <CardDescription>Advanced network security and optimization platform</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-muted-foreground leading-relaxed">
            Shield Network Guardian is a comprehensive network security and optimization platform designed to protect 
            and enhance your digital infrastructure. Whether you're safeguarding your family's home network, 
            managing a school's educational environment, or securing an enterprise workspace, our AI-powered 
            system provides real-time monitoring, threat detection, and performance optimization.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            Built with cutting-edge technology and years of cybersecurity expertise, Shield offers intuitive 
            interfaces that make complex network management accessible to everyone while providing enterprise-grade 
            security features for professional environments.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>The experts behind Shield Network Guardian</CardDescription>
        </CardHeader>
        <CardContent>
