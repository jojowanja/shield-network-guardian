...
export const UpgradePrompt = ({ deviceCount, usage, currentPlan }: UpgradePromptProps) => {
  ...
  const getUpgradeReason = () => {
    ...
    if (usage === "high") {
      return {
        ...
        description: "Your network is experiencing heavy traffic. Upgrade for AI optimization and priority management.",
  ...
  return (
    <Card className={`border-l-4 ${
      reason.urgency === "high" ? "border-l-destructive" : 
      reason.urgency === "medium" ? "border-l-yellow-500" : "border-l-primary"
      ...
      <CardContent className="pt-0">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span>Current Plan: <strong>{planType} Basic</strong></span>
          </div>
